...
//! slicing through multibyte characters. The character-based step makes
//! `chunk_size` and `overlap` behave predictably for Spanish clinical text
//! (accented characters and em-dashes are common).
