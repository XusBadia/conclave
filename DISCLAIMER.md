...
- On first launch (modal, must accept to continue).
- In the README.
- In the footer of every generated verdict.
- In Settings, accessible at any time.
...
Final responsibility for any clinical decision rests exclusively with the
treating healthcare professional. The user must verify all recommendations
against current evidence, local protocols, and the specific clinical
...
de la calidad, exactitud y completitud de la información aportada por el
usuario.

La responsabilidad final de cualquier decisión clínica recae exclusivamente
en el profesional sanitario tratante. El usuario debe contrastar todas las
recomendaciones con la evidencia vigente, los protocolos locales y las
circunstancias clínicas concretas de cada paciente.
